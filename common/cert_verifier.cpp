...
oe_result_t enclave_claims_verifier_callback_server(
    oe_claim_t* claims,
    size_t claims_length,
    void* arg);

oe_result_t enclave_claims_verifier_callback_client(
    oe_claim_t* claims,
    size_t claims_length,
    void* arg);

int cert_verify_callback_server(
    void* data,
...
int cert_verify_callback_client(
    void* data,
    mbedtls_x509_crt* crt,
    int depth,
    uint32_t* flags)
