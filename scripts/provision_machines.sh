...
python3 update_config.py -m="config/machines.json" config/adaptiveScaleThroughputOblix_500.json
python3 update_config.py -m="config/machines.json" config/adaptiveScaleThroughputOblix_300.json
