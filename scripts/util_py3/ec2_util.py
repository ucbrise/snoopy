...
all_ec2_regions = all_ec2_regions + ["eu-west-2", "ca-central-1"]
canada_region = boto.ec2.RegionInfo(
    None, "ca-central-1", "ec2.ca-central-1.amazonaws.com")
euwest_region = boto.ec2.RegionInfo(
    None, "eu-west-2", "ec2.eu-west-2.amazonaws.com")
useast_region = boto.ec2.RegionInfo(
    None, "us-east-2", "ec2.us-east-2.amazonaws.com")
...
def startConnection(region):
    ...
    if region == "eu-west-2" or region == "ca-central-1" or region == "us-east-2":
        if region == "eu-west-2":
            reg = euwest_region
        if region == "us-east-2":
            reg = useast_region
...
def printEc2Config(region, filter):
    ...
    if region == "eu-west-2" or region == "ca-central-1":
        if region == "eu-west-2":
            reg = euwest_region
        else:
            reg = canada_region
